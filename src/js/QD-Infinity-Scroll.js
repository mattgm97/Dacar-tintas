...
(function ($) {
	...
	$.fn.QD_infinityScroll = function (opts) {
		...
		var defaults = {
			...
			returnToTop: $('<div id="returnToTop" class="qd-is-return-top"><a href="#"><span class="text">voltar ao topo</span><span class="arrowToTop"><i class="fa fa-angle-up" style="color:white!important;font-size: 34px;"></i></span></a></div>'),
